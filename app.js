(() => {
  ...
  async function drawIdentityFrontCanvas(ctx, W, H) {
    ...
    ctx.fillText("PT KARSA LIFESTYLE NUSANTARA", W - pad, 138);
    ctx.textAlign = "left";
    ...
    drawCanvasWrapped(ctx, state.user.name || "—", infoX, 306, 710, 70);

    ctx.fillStyle = "#dfc58f";
    ctx.font = "700 38px Arial";
    drawCanvasWrapped(ctx, state.user.title || roleLabel(state.user.role) || "—", infoX, 384, 650, 42);
    ...
    ctx.fillText("●  ACTIVE", infoX + 25, 597);
    ...
    ctx.fillText("SCAN TO VERIFY", qrX, qrY + qrSize + 36);
    ...
    ctx.fillText(`KARSA ID  •  ${getIdentityId()}`, pad, stripY + 80);
    ...
    ctx.fillStyle = "#dfbd70";
    ctx.font = "900 25px Arial";
    ctx.fillText("PT KARSA LIFESTYLE NUSANTARA", W - pad, stripY + 80);
    ctx.textAlign = "left";
  }
  ...
  async function drawIdentityBackCanvas(ctx, W, H) {
    ...
    ctx.fillStyle = "#9d8961"; ctx.font = "700 28px Arial"; ctx.fillText("OFFICIAL EMPLOYEE IDENTITY", 164, 154);

    ctx.fillStyle = "#f1ede5"; ctx.font = "800 37px Arial"; ctx.fillText("PT Karsa Lifestyle Nusantara", pad, 244);
    ctx.fillStyle = "#9f927d"; ctx.font = "600 25px Arial"; ctx.fillText("KARSA INTERNAL IDENTITY SYSTEM", pad, 278);
    ...
    items.forEach((it, i) => {
      ...
      ctx.fillStyle = "#8f8068"; ctx.font = "800 24px Arial"; ctx.fillText(it[0], x + 24, y + 32);
      ctx.fillStyle = "#eee9df"; ctx.font = "700 28px Arial"; drawCanvasWrapped(ctx, it[1], x + 24, y + 70, boxW - 48, 28);
    });

    ctx.fillStyle = "#d3b06a"; ctx.font = "800 24px Arial"; ctx.textAlign = "center"; ctx.fillText(`KARSA IDENTITY  •  ${getIdentityId()}`, W / 2, H - 88);
    ctx.fillStyle = "#6f685e"; ctx.font = "600 19px Arial"; ctx.fillText("Valid for authorized internal use of PT Karsa Lifestyle Nusantara.", W / 2, H - 62);
    ctx.textAlign = "left";
  }
